...
public class Help {
    ...
    public static boolean onHelp(Player p, String slash, String schemAlias) {
        if (DefaultUtils.getBoolean("Space Lists")) {
            p.sendMessage(" ");
        }
        ...
        p.sendMessage(ChatColor.AQUA + "=== SchemManager | Version "
                ...
                + " ===");
        DefaultUtils.sendSuggestMessage(ChatColor.RED + "Get some help: ",
        ...
        DefaultUtils.sendSuggestMessage(ChatColor.RED + "Load a schematic: ",
        ...
        DefaultUtils.sendSuggestMessage(ChatColor.RED + "Show Available formats: ",
        ...
        DefaultUtils.sendSuggestMessage(ChatColor.RED + "Save a schematic: ",
        ...
        DefaultUtils.sendSuggestMessage(ChatColor.RED + "Rename a schematic: ",
        ...
        DefaultUtils.sendSuggestMessage(ChatColor.RED + "Rename a folder: ",
        ...
        DefaultUtils.sendSuggestMessage(ChatColor.RED + "Delete a schematic: ",
        ...
        DefaultUtils.sendSuggestMessage(ChatColor.RED + "Delete a folder: ",
        ...
        DefaultUtils.sendSuggestMessage(ChatColor.RED + "List schematics: ",
        ...
        DefaultUtils.sendSuggestMessage(ChatColor.RED + "List folder: ",
        ...
        DefaultUtils.sendSuggestMessage(ChatColor.RED + "Search for a schematic: ",
        ...
        DefaultUtils.sendSuggestMessage(ChatColor.RED + "Search for a folder: ",
        ...
        DefaultUtils.sendSuggestMessage(ChatColor.RED + "Update the plugin: ",
        ...
        DefaultUtils.sendSuggestMessage(ChatColor.RED + "Disable the plugin: ",
    ...
    public static boolean onFormats(Player p, boolean suppressBlankLine) {
        if (DefaultUtils.getBoolean("Space Lists") && !suppressBlankLine) {
            p.sendMessage(" ");
        }
        p.sendMessage(ChatColor.RED + "Available formats:");
        if (DefaultUtils.getStringList("File Extensions").size() > 0) {
            String[] formats = DefaultUtils.getStringList("File Extensions").toArray(new String[0]);

...
public class CommandHandler implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (command.getName().equalsIgnoreCase("schemmanager")) {
            if (sender instanceof Player) {
                ...
                if (args.length == 0) {
                    p.sendMessage(ChatColor.DARK_BLUE + "[" + ChatColor.DARK_PURPLE + "SchemManager" + ChatColor.DARK_BLUE + "] " + ChatColor.RED + "Missing argument for " + ChatColor.YELLOW + "<" + ChatColor.GOLD
                    ...
                    if (args.length == 1) {
                        MessageUtils.sendBooleanMessage(ChatColor.DARK_BLUE + "[" + ChatColor.DARK_PURPLE + "SchemManager" + ChatColor.DARK_BLUE + "] " + ChatColor.RED + "Do you really want to disable " + ChatColor.DARK_PURPLE
                        ...
                        if (args[1].equalsIgnoreCase("confirm") && RequestUtils.checkDisableRequest(p)) {
                            p.sendMessage(ChatColor.DARK_BLUE + "[" + ChatColor.DARK_PURPLE + "SchemManager" + ChatColor.DARK_BLUE + "] " + ChatColor.DARK_PURPLE + "SchemManager" + ChatColor.RED + " is being disabled.");
                            ...
                            p.sendMessage(ChatColor.DARK_BLUE + "[" + ChatColor.DARK_PURPLE + "SchemManager" + ChatColor.DARK_BLUE + "] " + ChatColor.DARK_PURPLE + "SchemManager" + ChatColor.RED + " will not be disabled.");
                            return true;
                        } else {
                            return true;
                        }
                    } else {
                        p.sendMessage(ChatColor.DARK_BLUE + "[" + ChatColor.DARK_PURPLE + "SchemManager" + ChatColor.DARK_BLUE + "] " + ChatColor.RED + "Too many arguments.");
                        return sendDisableUsage(p);
                    }
                } else if (args[0].equalsIgnoreCase("update") && p.hasPermission("schemmanager.update")) {
                    if (args.length == 1) {
                        MessageUtils.sendBooleanMessage(ChatColor.DARK_BLUE + "[" + ChatColor.DARK_PURPLE + "SchemManager" + ChatColor.DARK_BLUE + "] " + ChatColor.RED + "Do you really want to update?", "/schemmanager update confirm",
                        ...
                        if (args[1].equalsIgnoreCase("confirm") && RequestUtils.checkUpdateRequest(p)) {
                            ...
                            RequestUtils.removeUpdateRequest(p);
                            p.sendMessage(ChatColor.DARK_BLUE + "[" + ChatColor.DARK_PURPLE + "SchemManager" + ChatColor.DARK_BLUE + "] " + ChatColor.DARK_PURPLE + "SchemManager" + ChatColor.RED + " will not be updated.");
                            return true;
                        } else {
                            return true;
                        }
                    ...
                    p.sendMessage(ChatColor.DARK_BLUE + "[" + ChatColor.DARK_PURPLE + "SchemManager" + ChatColor.DARK_BLUE + "] " + ChatColor.RED + "Invalid sub-command '" + ChatColor.GOLD + "" + args[0] + ChatColor.RED + ".");
                    return sendUpdateUsage(p) && sendDisableUsage(p);
    ...
    private boolean sendUpdateUsage(Player p) {
        MessageUtils.sendSuggestMessage(ChatColor.DARK_BLUE + "[" + ChatColor.DARK_PURPLE + "SchemManager" + ChatColor.DARK_BLUE + "] " + ChatColor.RED + "Usage: ",

...
# You don't need to update the plugin when editing the config, it will automatically detect changes.           #
...
# Automatic Reload: Should the plugin automatically update the Server after it got updated?                    #
# If you have PlugMan installed, it will only update itself, not the whole server.                             #
